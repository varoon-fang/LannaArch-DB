$(document).ready(function(){
        $('#options').change(function(){ //any select change on the dropdown with id options trigger this code
            ...
            $.ajax({
                type: "POST",
                url: "http://abcdproperty.com/2013/backoffice/property/getsuboptions/"+option, //here we are calling our dropdown controller and getsuboptions method passing the option
