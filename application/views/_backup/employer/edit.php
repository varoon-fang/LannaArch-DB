...
<?php $this->load->view('backoffice/components/page_subhead');?>
         ...
         <h2>แก้ไขข้อมูลหมวดหมู่งาน</h2>
         <br />
        <?= form_open("backoffice/category/edit/".$this->uri->segment(4), array('id' =>'contact-form', 'name' =>'myform'));?>
  ...
  <div class="well">
	<p><span class="badge badge-inverse">1.</span> <strong>( ข้อมูล )</strong></p>
	   ...
	   <div class="control-group">
		  ...
		  <div class="controls">
		    <input type="text" name="title_th" id="title_th" value="<?= $rs['cate_name'];?>" required="required" class="span6">
		  </div>
		</div>
