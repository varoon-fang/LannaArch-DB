...
<div class="span9">
         ...
         <h3>เพิ่มข้อมูลแบบสถาปัตยกรรม</h3>
         <br />
        <?= form_open_multipart('admin/layout_arch/add', array('id' =>'contact-form', 'name' =>'myform'));?>
	    	  ...
	    	  <div class="controls">
	    	    <select name="group" required="reauired">
	    	    	...
	    	    	<?php
	    	    		...
	    	    		{
	    	    	?>
	    	    	<option value="<?= $row['layout_group_id'];?>"><?= $row['layout_group_name'];?></option>
	    	    	<? }?>
	    	    </select>
	    	  </div>
	    	</div>
