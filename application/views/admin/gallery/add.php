...
<div class="span9">
         ...
         <h2>เพิ่มข้อมูลห้องภาพ</h2>
         <br />
        <?= form_open_multipart('admin/gallery/add', array('id' =>'contact-form', 'name' =>'myform'));?>
	    	  ...
	    	  <div class="controls">
	    	    <select name="group" required="reauired">
	    	    	...
	    	    	<?php
	    	    		...
	    	    		{
	    	    	?>
	    	    	<option value="<?= $row['gallery_group_id'];?>"><?= $row['gallery_group_name'];?></option>
	    	    	<? }?>
	    	    </select>
	    	  </div>
	    	</div>
	    ...
	    <div class="control-group">
		  <label class="control-label">ที่มาของภาพ :</label>
		  <div class="controls">

		    <textarea id="detail_th" name="detail_th" rows="5"  class="span6" placeholder="กรอกข้อความ…"></textarea>
