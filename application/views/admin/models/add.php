...
<?php $this->load->view('admin/components/page_subhead');?>
         ...
         <h2>เพิ่มข้อมูลภาพหุ่นจำลอง </h2>
         <br />
        <?= form_open_multipart('admin/models/add', array('id' =>'contact-form', 'name' =>'myform'));?>
  ...
  <div class="well">
	<p><span class="badge badge-inverse">1.</span> <strong>( ข้อมูล )</strong></p>
	    ...
	    <div class="control-group">
		  <label class="control-label" for="name">ชื่อภาพหุ่นจำลอง :</label>
		  <div class="controls">
