...
<div class="span9">
         ...
         <h3>เพิ่มข้อมูลข้อมูลทั่วไป</h3>
         <br />
        <?= form_open_multipart('admin/information/add', array('id' =>'contact-form', 'name' =>'myform'));?>
	    	  ...
	    	  <div class="controls">
	    	    <select name="group" required="reauired">
	    	    	...
	    	    	<?php
	    	    		...
	    	    		{
	    	    	?>
	    	    	<option value="<?= $row['information_group_id'];?>"><?= $row['information_group_name'];?></option>
	    	    	<? }?>
	    	    </select>
	    	  </div>
	    	</div>
