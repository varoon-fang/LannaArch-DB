...
class Library extends CI_Controller {
	...
	function more()
	{
		...
		$config['base_url']=site_url()."library/more/";
		$config['per_page']=18;
		...
		$data['rs_ebook']= $res_book = $this->db->select('*')->from('ebook')->where('ebook_group', $page_id)->limit($config['per_page'],$this->uri->segment(4))->get()->result_array();
